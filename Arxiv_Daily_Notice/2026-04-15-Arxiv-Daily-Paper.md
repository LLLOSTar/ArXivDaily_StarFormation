...
#### Astrophysical parameters of LS 437 and the nature of X0726-260
 - **Authors:** Ignacio Negueruela (Alicante), Sara R. Berlanas (Alicante &amp; IAC), Lee J. Townsend (SAAO), Javier Lorenzo (Alicante), Klaus Rübke (Alicante)
 - **Subjects:** Subjects:
Solar and Stellar Astrophysics (astro-ph.SR)
 - **Arxiv link:** https://arxiv.org/abs/2604.12078

 - **Pdf link:** https://arxiv.org/pdf/2604.12078
...
#### A First Principles Approach to the 100,000-year Problem
 - **Authors:** Liam Wheen
 - **Subjects:** Subjects:
Earth and Planetary Astrophysics (astro-ph.EP); Chaotic Dynamics (nlin.CD); Atmospheric and Oceanic Physics (physics.ao-ph)
